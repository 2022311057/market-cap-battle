const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    title: '⑤ カードを選んでバトル！',
    body: '試しに1枚自動で選択しました。このまま「対決！」を押すと勝負が始まります。相手より選んだ指標が大きければ勝ち（100点）！連続して勝つと連勝ボーナスが付きます（2連勝+30点・3,4連勝+50点・5連勝+70点）。手札に余裕があれば2枚合体（M&A）もできます。',
    action: 'selectFirstCard',
  },
  {
    focus: null,
    title: '⑥ スコアと評価',
    body: '5ラウンド戦って合計スコアで評価されます。勝利100点＋連勝ボーナス（2連勝+30・3,4連勝+50・5連勝+70）で最大700点満点。合計スコアに応じて星1〜5の評価が付きます。さあ、連勝を狙って対戦を続けてみましょう！',
    isFinal: true,
  },
];
