const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    title: '⑤ カードを選んでバトル！',
    body: '試しに1枚自動で選択しました。このまま「対決！」を押すと勝負が始まります。相手より選んだ指標が大きければ勝ち（100点）！ギリギリ勝ち（差10%未満）なら+50点のボーナスも。手札に余裕があれば2枚合体（M&A）もできます。',
    action: 'selectFirstCard',
  },
  {
    focus: null,
    title: '⑥ スコアと評価',
    body: '5ラウンド戦って合計スコアで評価されます。勝利 100点 ＋ ギリギリ勝ちボーナス最大+50点。合計スコアに応じて星1〜5の評価が付きます。さあ、このまま対戦を続けてみましょう！',
    isFinal: true,
  },
];
